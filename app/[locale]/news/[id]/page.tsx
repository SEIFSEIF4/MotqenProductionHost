            ...
            <div className="flex flex-1 flex-col justify-between px-4 pt-14">
              <CardHeader className="gap-y-1 space-y-2 p-0">
                ...
                <CardDescription className="text-right text-base font-medium leading-relaxed text-gray-600 md:text-xl">
                  أعلنت جمعية متقن لتعليم القرآن الكريم عن إطلاق مبادرة نوعية
                  تهدف إلى تسهيل تعليم وتحفيظ القرآن الكريم باستخدام التقنيات
                  الحديثة.
                  <div className="h-4" />
                  وتشمل المبادرة منصة تعليمية إلكترونية تتيح للطلاب والطالبات
                  الوصول إلى دروس تفاعلية وبرامج متخصصة في علوم القرآن.
                  <div className="h-4" />
                  وتأتي هذه الخطوة في إطار حرص الجمعية على مواكبة التطورات
                  التقنية وتوفير بيئة تعليمية محفزة تعزز من فهم كتاب الله وحفظه.
                  وتهدف الجمعية من خلال هذه المبادرة إلى توسيع نطاق خدماتها
                  والوصول إلى أكبر عدد من المستفيدين داخل المملكة وخارجها.
                  <div className="h-4" />
