    ...
    <div className="mx-auto p-4">
      <div className="relative rounded-lg bg-[#155C67] p-6 pb-12 text-white">
        ...
        <div className="absolute left-1/2 top-[90%] w-[80vw] -translate-x-1/2 rounded-lg bg-white p-4 text-gray-900 shadow-md">
          ...
          <div className="flex flex-col justify-start gap-x-52 md:flex-row">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-[#161616]">{t("duration.title")}</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-[#161616]">{t("howMuch.title")}</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="relative -top-1 inline-flex h-8 w-8 items-center justify-center rounded-full bg-gray-100">
              ...
              <div>
                ...
                <p className="text-sm text-[#161616]">{t("days.title")}</p>
              </div>
            </div>
          </div>

          <div className="mt-4 flex justify-start gap-2">
            <button className="rounded-md bg-teal-600 px-4 py-2 text-white">
              {t("buttons.women")}
            </button>
            <button className="rounded-md bg-teal-600 px-4 py-2 text-white">
              {t("buttons.men")}
