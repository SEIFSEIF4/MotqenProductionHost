  ...
  return (
    <SectionWrapper id="about" className="z-10 bg-white">
      ...
      <div className="grid grid-cols-1 gap-3 rounded-lg py-5 md:grid-cols-10 md:py-16">
        <div
          className={`group relative col-span-7 overflow-hidden rounded-2xl p-6 text-white backdrop-blur-xl duration-300 hover:rounded-3xl ${locale === "ar" ? "md:h-[186px]" : "lg:h-[186px]"}`}
        >
          <div
