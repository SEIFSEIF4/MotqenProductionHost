...
const NavbarMenuItem = ({
  ...
  return (
    <NavigationMenuItem>
      <NavigationMenuTrigger
        className={`flex ${locale === "ar" && "flex-row-reverse"} relative py-8 text-base after:absolute after:bottom-0 after:left-1/2 after:h-[6px] after:w-[0%] after:-translate-x-1/2 after:rounded-full after:bg-[#6FA0A7] after:transition-all hover:after:w-[80%]`}
      >
        {translations}
      </NavigationMenuTrigger>
