...
const Footer = () => {
  ...
  return (
    <footer className="group relative z-0 overflow-hidden bg-primary px-6 py-6 text-sm text-white">
      {/* Decorative Background */}
      <FooterIcons.LargePattern className="absolute bottom-[-17px] -z-10 hidden opacity-50 transition-all duration-500 group-hover:opacity-100 md:block ltr:right-0 ltr:-scale-x-100 rtl:left-0" />
